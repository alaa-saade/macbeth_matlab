...
/* The computational routine */
 void compute_current_estimate(double *x, double *I, double *J,double *VAL,double n, double m, double r,double nnz,double *COST)
 {
    COST[0] = 0.0;
    for(int k=0;k<nnz;k++){
        double xyt = 0.0;
  ...
  int nrhs, const mxArray *prhs[])
{
    ...
    compute_current_estimate(x,I,J,VAL,n,m,r,nnz,COST);
}
